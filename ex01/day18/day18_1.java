...
public class day18_1 implements Serializable {
	private int rank;
	private String song;
	...
	public day18_1() {}
	public day18_1(int rank, String song, int lastweek, String imagesrc, String artistsrc, String artist) {
		super();
		this.rank=rank;
		this.song=song;
	...
	public day18_1(int rank, String song, int lastweek, String imagesrc, String artist) {
		super();
		this.rank=rank;
		this.song=song;
		this.lastweek=lastweek;
